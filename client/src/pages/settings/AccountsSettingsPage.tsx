...
const AccountsSettingsPage: React.FC<AccountsSettingsPageProps> = ({ accounts }) => {
...
const EnhancedAccountsSettingsPage = () => {
  const { tenantId } = useParams();
  const EnhancedAccountsSettingsPage = enhance(AccountsSettingsPage);
  return <EnhancedAccountsSettingsPage tenantId={tenantId} />;
};

export default EnhancedAccountsSettingsPage; 